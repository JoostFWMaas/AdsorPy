...
"""2D array of bools."""
BufferArray: TypeAlias = np.ndarray[tuple[int, int], np.dtype[Polygon]]  # type: ignore[type-var] # pyright: ignore[reportInvalidTypeArguments]
...
GeoArray: TypeAlias = np.ndarray[tuple[int], np.dtype[Polygon]]  # type: ignore[type-var] # pyright: ignore[reportInvalidTypeArguments]
"""1D array of Polygons."""
IdxArray: TypeAlias = np.ndarray[tuple[int], np.dtype[np.int64]]  # Flat index aray of integers.
...
PrepGeoArray: TypeAlias = "np.ndarray[tuple[int], np.dtype[PreparedGeometry[Polygon]]]"  # pyright: ignore[reportInvalidTypeArguments]
